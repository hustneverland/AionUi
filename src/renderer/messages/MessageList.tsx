    ...
    return (
      <div
        ...
        className={classNames(
          'min-w-0 flex items-start message-item [&>div]:max-w-full px-8px m-t-10px max-w-full md:max-w-780px mx-auto overflow-x-hidden',
          message.type,
          {
    ...
    if ('type' in item && ['file_summary', 'tool_summary'].includes(item.type)) {
      return (
        <div
          ...
          className={'min-w-0 message-item px-8px m-t-10px max-w-full md:max-w-780px mx-auto overflow-x-hidden ' + item.type}
          style={highlighted ? highlightStyle : undefined}
        >
